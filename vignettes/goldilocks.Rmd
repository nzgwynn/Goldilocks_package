...
A video detailing how to use the first three panels can be found [here](https://www.youtube.com/watch?v=GZz7D3OwYKo). And an this [article]([https://www.sciencedirect.com/science/article/pii/S245186542100048X)](https://www.sciencedirect.com/science/article/pii/S245186542100048X)) gives full details about how researchers can use `{goldilocks}` in practice.
