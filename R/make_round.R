...
#' recolors the plot
#'
#' @param column a string that says which column should be used
#' to color the parallel coordinates plot
#' @param data a dataframe made in make.Ks that need to be colored
#' @param M a number which is the Max number of colors allowed
#' in YlGnBu palette from RColorBrewer is 9
#'
