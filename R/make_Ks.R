...
#'
#' @import stats
#' @param M a numeric vector of length one that is the number of
#'  times to practice randomizing, if this is too large it is hard
#'  to read the parallel coordinates plot. We recommend 300
#'  which is the default.
#' @param vars a nested list that contains 5 things. In order:
#' the names of the variables, the weights, the labels for the
